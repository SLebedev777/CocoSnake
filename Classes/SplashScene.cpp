...
bool SplashScene::init()
{
    ...
    buttons_callbacks.push_back({ button_continue, [=](Ref* sender) { onContinueCallback(sender); } });
    buttons_callbacks.push_back({ button_quit, [=](Ref* sender) { onQuitCallback(sender); } });
